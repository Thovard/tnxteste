...
<h1 class="text-center text-3xl font-semibold leading-tigh py-2">
    ...
    <a href="/empresas" class=" absolute top-3 left-2 h-auto w-auto text-sm text-reigth bg-green-200 rounded-full py-2 px-6"> 
...
<table class="min-w-[50%] leading-normal shadow-md rounded-lg overflow-hidden">
    <thead>
        <tr>
            ...
            <th class="px-5 py-3 border-4 border-gray-300 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Deletar Empresa</th>
...
<tr>
    ...
    <td class="px-20 py-5 border-2 border-gray-200 bg-white text-sm">
        <a href="{{route('empresa.show', $empresas->id)}}" class="bg-green-200 rounded-full py-2 px-6 ">
            acessar empresa
        </a>
    </td>
    <td class="px-20 py-5 border-2 border-gray-200 bg-white text-sm">
