@csrf
        ...
        <input type="text" name="Categoria" placeholder="Categoria:" value="{{ $vendedor->Categoria ?? old('Categoria')}}"class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline my-2">
